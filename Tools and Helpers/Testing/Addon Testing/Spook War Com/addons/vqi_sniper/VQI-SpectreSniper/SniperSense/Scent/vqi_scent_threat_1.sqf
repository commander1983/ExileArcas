...
_rScent = [1,40] call BIS_fnc_randomInt;
switch (_rScent) do
{
   ...
   case 33 : { hint "Bodyodor; Human"; };
   case 34 : { hint "Chemical; Cleaner"; };
   case 35 : { hint "Chemical; Chlorine"; };
   case 36 : { hint "Chemical; Clorox"; };
   case 37 : { hint "Chemical; Dryer Sheet"; };
   case 38 : { hint "Chemical; Shampoo"; };
   case 39 : { hint "Chemical; Toothpaste"; };
   case 40 : { hint "Chemical; Antiseptic"; };
};
